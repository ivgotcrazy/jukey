...
// 
//==============================================================================
class RawVideoRenderProcessor : public PipelineProcessorBase
{
public:
	RawVideoRenderProcessor(PipelineProcessorMgr* mgr);
	~RawVideoRenderProcessor();
...
typedef std::shared_ptr<RawVideoRenderProcessor> RawVideoRenderProcessorSP;
