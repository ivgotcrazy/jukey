...
// 
//==============================================================================
class VideoStreamSrcProcessor : public PipelineProcessorBase
{
public:
	VideoStreamSrcProcessor(PipelineProcessorMgr* mgr);
	~VideoStreamSrcProcessor();
...
typedef std::shared_ptr<VideoStreamSrcProcessor> VideoStreamSrcProcessorSP;
