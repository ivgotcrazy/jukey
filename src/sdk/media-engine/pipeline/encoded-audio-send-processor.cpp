...
// 
//------------------------------------------------------------------------------
EncodedAudioSendProcessor::EncodedAudioSendProcessor(PipelineProcessorMgr* mgr)
	: PipelineProcessorBase(mgr->m_factory, PPMT_PROCESSOR, 
		PPST_AUDIO_ENCODED_SENDER, mgr)
	, m_pl_proc_mgr(mgr)
{
...
// 
//------------------------------------------------------------------------------
EncodedAudioSendProcessor::~EncodedAudioSendProcessor()
{
...
// 
//------------------------------------------------------------------------------
ErrCode EncodedAudioSendProcessor::Init(const com::MediaStream& stream,
	const std::string& addr)
{
	...
	LOG_INF("Init EncodedAudioSendProcessor success");
...
// 
//------------------------------------------------------------------------------
bool EncodedAudioSendProcessor::AllocSinkPin(const std::string& stream_id,
	com::ElementPin& pin)
{
	if (!m_decode_element) {
...
// 
//------------------------------------------------------------------------------
void EncodedAudioSendProcessor::ReleaseSinkPin(const com::ElementPin& pin)
{
	LOG_INF("{}", __FUNCTION__);
}
...
// 
//------------------------------------------------------------------------------
bool EncodedAudioSendProcessor::ContainStream(const std::string& stream_id)
{
