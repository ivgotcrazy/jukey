...
namespace jukey {
namespace prot {
PROTOBUF_CONSTEXPR NetStream::NetStream(
...
struct NetStreamDefaultTypeInternal {
  PROTOBUF_CONSTEXPR NetStreamDefaultTypeInternal()
      : _instance(::_pbi::ConstantInitialized{}) {}
  ~NetStreamDefaultTypeInternal() {}
  union {
    NetStream _instance;
  };
};
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 NetStreamDefaultTypeInternal _NetStream_default_instance_;
}  // namespace prot
}  // namespace jukey
...
const uint32_t TableStruct_common_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::jukey::prot::NetStream, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::jukey::prot::NetStream, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::jukey::prot::NetStream, _impl_.app_id_),
  PROTOBUF_FIELD_OFFSET(::jukey::prot::NetStream, _impl_.user_id_),
  PROTOBUF_FIELD_OFFSET(::jukey::prot::NetStream, _impl_.stream_type_),
  PROTOBUF_FIELD_OFFSET(::jukey::prot::NetStream, _impl_.stream_id_),
  PROTOBUF_FIELD_OFFSET(::jukey::prot::NetStream, _impl_.media_src_type_),
  PROTOBUF_FIELD_OFFSET(::jukey::prot::NetStream, _impl_.media_src_id_),
  2,
  3,
  4,
  0,
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 12, -1, sizeof(::jukey::prot::NetStream)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::jukey::prot::_NetStream_default_instance_._instance,
};

const char descriptor_table_protodef_common_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\014common.proto\022\njukey.prot\"\202\001\n\tNetStream"
  "\022\016\n\006app_id\030\001 \002(\r\022\017\n\007user_id\030\002 \002(\r\022\023\n\013str"
  "eam_type\030\003 \002(\r\022\021\n\tstream_id\030\004 \002(\t\022\026\n\016med"
  "ia_src_type\030\005 \002(\r\022\024\n\014media_src_id\030\006 \002(\t"
  ;
static ::_pbi::once_flag descriptor_table_common_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_common_2eproto = {
    false, false, 159, descriptor_table_protodef_common_2eproto,
    "common.proto",
...
class NetStream::_Internal {
 public:
  using HasBits = decltype(std::declval<NetStream>()._impl_._has_bits_);
...
NetStream::NetStream(::PROTOBUF_NAMESPACE_ID::Arena* arena,
                         bool is_message_owned)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:jukey.prot.NetStream)
}
NetStream::NetStream(const NetStream& from)
  : ::PROTOBUF_NAMESPACE_ID::Message() {
  NetStream* const _this = this; (void)_this;
  new (&_impl_) Impl_{
  ...
  ::memcpy(&_impl_.app_id_, &from._impl_.app_id_,
    ...
    reinterpret_cast<char*>(&_impl_.app_id_)) + sizeof(_impl_.media_src_type_));
  // @@protoc_insertion_point(copy_constructor:jukey.prot.NetStream)
}

inline void NetStream::SharedCtor(
...
NetStream::~NetStream() {
  // @@protoc_insertion_point(destructor:jukey.prot.NetStream)
...
inline void NetStream::SharedDtor() {
  GOOGLE_DCHECK(GetArenaForAllocation() == nullptr);
  _impl_.stream_id_.Destroy();
  _impl_.media_src_id_.Destroy();
}

void NetStream::SetCachedSize(int size) const {
  _impl_._cached_size_.Set(size);
}

void NetStream::Clear() {
// @@protoc_insertion_point(message_clear_start:jukey.prot.NetStream)
...
const char* NetStream::_InternalParse(const char* ptr, ::_pbi::ParseContext* ctx) {
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "jukey.prot.NetStream.stream_id");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
      ...
      case 6:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 50)) {
          ...
          CHK_(ptr);
          #ifndef NDEBUG
          ::_pbi::VerifyUTF8(str, "jukey.prot.NetStream.media_src_id");
          #endif  // !NDEBUG
        } else
          goto handle_unusual;
        continue;
...
uint8_t* NetStream::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:jukey.prot.NetStream)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000010u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(3, this->_internal_stream_type(), target);
  }
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      "jukey.prot.NetStream.stream_id");
  ...
  if (cached_has_bits & 0x00000020u) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(5, this->_internal_media_src_type(), target);
  }
  ...
  if (cached_has_bits & 0x00000002u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "jukey.prot.NetStream.media_src_id");
    target = stream->WriteStringMaybeAliased(
        6, this->_internal_media_src_id(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:jukey.prot.NetStream)
  return target;
}

size_t NetStream::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:jukey.prot.NetStream)
  size_t total_size = 0;
...
size_t NetStream::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:jukey.prot.NetStream)
  size_t total_size = 0;
...
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData NetStream::_class_data_ = {
    ::PROTOBUF_NAMESPACE_ID::Message::CopyWithSourceCheck,
    NetStream::MergeImpl
};
const ::PROTOBUF_NAMESPACE_ID::Message::ClassData*NetStream::GetClassData() const { return &_class_data_; }


void NetStream::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  auto* const _this = static_cast<NetStream*>(&to_msg);
  auto& from = static_cast<const NetStream&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:jukey.prot.NetStream)
...
void NetStream::CopyFrom(const NetStream& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:jukey.prot.NetStream)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool NetStream::IsInitialized() const {
  if (_Internal::MissingRequiredFields(_impl_._has_bits_)) return false;
  return true;
}

void NetStream::InternalSwap(NetStream* other) {
  using std::swap;
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(NetStream, _impl_.media_src_type_)
      + sizeof(NetStream::_impl_.media_src_type_)
      - PROTOBUF_FIELD_OFFSET(NetStream, _impl_.app_id_)>(
          reinterpret_cast<char*>(&_impl_.app_id_),
          reinterpret_cast<char*>(&other->_impl_.app_id_));
}

::PROTOBUF_NAMESPACE_ID::Metadata NetStream::GetMetadata() const {
...
template<> PROTOBUF_NOINLINE ::jukey::prot::NetStream*
Arena::CreateMaybeMessage< ::jukey::prot::NetStream >(Arena* arena) {
  return Arena::CreateMessageInternal< ::jukey::prot::NetStream >(arena);
}
